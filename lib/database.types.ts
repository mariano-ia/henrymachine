...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      experiences: {
        Row: { author_id: string; city: string | null; cover_path: string | null; created_at: string; currency: string; distance_m: number | null; expected_minutes: number | null; generated_from: string | null; id: string; language: string; neighborhood: string | null; pitch: string | null; price_cents: number; published_at: string | null; resume_window_hours: number; slug: string; status: Database["public"]["Enums"]["experience_status"]; stripe_price_id: string | null; theme: string | null; title: string; updated_at: string; voice_override: Json | null; voice_profile_id: string | null }
        Insert: { author_id: string; city?: string | null; cover_path?: string | null; created_at?: string; currency?: string; distance_m?: number | null; expected_minutes?: number | null; generated_from?: string | null; id?: string; language?: string; neighborhood?: string | null; pitch?: string | null; price_cents?: number; published_at?: string | null; resume_window_hours?: number; slug: string; status?: Database["public"]["Enums"]["experience_status"]; stripe_price_id?: string | null; theme?: string | null; title: string; updated_at?: string; voice_override?: Json | null; voice_profile_id?: string | null }
        Update: { author_id?: string; city?: string | null; cover_path?: string | null; created_at?: string; currency?: string; distance_m?: number | null; expected_minutes?: number | null; generated_from?: string | null; id?: string; language?: string; neighborhood?: string | null; pitch?: string | null; price_cents?: number; published_at?: string | null; resume_window_hours?: number; slug?: string; status?: Database["public"]["Enums"]["experience_status"]; stripe_price_id?: string | null; theme?: string | null; title?: string; updated_at?: string; voice_override?: Json | null; voice_profile_id?: string | null }
        Relationships: []
      }
      generation_jobs: {
