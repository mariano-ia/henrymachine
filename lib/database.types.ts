...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      experiences: {
        Row: { author_id: string; city: string | null; cover_path: string | null; created_at: string; currency: string; expected_minutes: number | null; generated_from: string | null; id: string; language: string; pitch: string | null; price_cents: number; published_at: string | null; resume_window_hours: number; slug: string; status: Database["public"]["Enums"]["experience_status"]; stripe_price_id: string | null; title: string; updated_at: string; voice_override: Json | null; voice_profile_id: string | null }
        Insert: { author_id: string; city?: string | null; cover_path?: string | null; created_at?: string; currency?: string; expected_minutes?: number | null; generated_from?: string | null; id?: string; language?: string; pitch?: string | null; price_cents?: number; published_at?: string | null; resume_window_hours?: number; slug: string; status?: Database["public"]["Enums"]["experience_status"]; stripe_price_id?: string | null; title: string; updated_at?: string; voice_override?: Json | null; voice_profile_id?: string | null }
        Update: { author_id?: string; city?: string | null; cover_path?: string | null; created_at?: string; currency?: string; expected_minutes?: number | null; generated_from?: string | null; id?: string; language?: string; pitch?: string | null; price_cents?: number; published_at?: string | null; resume_window_hours?: number; slug?: string; status?: Database["public"]["Enums"]["experience_status"]; stripe_price_id?: string | null; title?: string; updated_at?: string; voice_override?: Json | null; voice_profile_id?: string | null }
        Relationships: []
      }
      generation_jobs: {
      ...
      play_sessions: {
        Row: { anon_id: string | null; created_at: string; current_step_position: number; email: string | null; entitlement_id: string | null; experience_id: string; expires_at: string | null; id: string; last_active_at: string; mode: Database["public"]["Enums"]["interaction_mode"]; paywall_passed: boolean; phase: Database["public"]["Enums"]["tour_phase"]; started_at: string | null; status: Database["public"]["Enums"]["session_status"]; total_turns: number; turns_in_step: number; user_id: string | null; wind_down: boolean }
        Insert: { anon_id?: string | null; created_at?: string; current_step_position?: number; email?: string | null; entitlement_id?: string | null; experience_id: string; expires_at?: string | null; id?: string; last_active_at?: string; mode?: Database["public"]["Enums"]["interaction_mode"]; paywall_passed?: boolean; phase?: Database["public"]["Enums"]["tour_phase"]; started_at?: string | null; status?: Database["public"]["Enums"]["session_status"]; total_turns?: number; turns_in_step?: number; user_id?: string | null; wind_down?: boolean }
        Update: { anon_id?: string | null; created_at?: string; current_step_position?: number; email?: string | null; entitlement_id?: string | null; experience_id?: string; expires_at?: string | null; id?: string; last_active_at?: string; mode?: Database["public"]["Enums"]["interaction_mode"]; paywall_passed?: boolean; phase?: Database["public"]["Enums"]["tour_phase"]; started_at?: string | null; status?: Database["public"]["Enums"]["session_status"]; total_turns?: number; turns_in_step?: number; user_id?: string | null; wind_down?: boolean }
        Relationships: []
      }
      purchases: {
        Row: { amount_cents: number; anon_id: string | null; created_at: string; currency: string; experience_id: string; id: string; paid_at: string | null; purchaser_email: string | null; refunded_at: string | null; status: Database["public"]["Enums"]["purchase_status"]; stripe_checkout_session_id: string | null; stripe_event_id: string | null; stripe_payment_intent_id: string | null; user_id: string | null }
        Insert: { amount_cents?: number; anon_id?: string | null; created_at?: string; currency?: string; experience_id: string; id?: string; paid_at?: string | null; purchaser_email?: string | null; refunded_at?: string | null; status?: Database["public"]["Enums"]["purchase_status"]; stripe_checkout_session_id?: string | null; stripe_event_id?: string | null; stripe_payment_intent_id?: string | null; user_id?: string | null }
        Update: { amount_cents?: number; anon_id?: string | null; created_at?: string; currency?: string; experience_id?: string; id?: string; paid_at?: string | null; purchaser_email?: string | null; refunded_at?: string | null; status?: Database["public"]["Enums"]["purchase_status"]; stripe_checkout_session_id?: string | null; stripe_event_id?: string | null; stripe_payment_intent_id?: string | null; user_id?: string | null }
        Relationships: []
      }
      sales: {
      ...
      session_messages: {
        Row: { created_at: string; id: string; intent: string | null; media_id: string | null; phase: Database["public"]["Enums"]["tour_phase"] | null; role: Database["public"]["Enums"]["message_role"]; session_id: string; step_position: number | null; text: string }
        Insert: { created_at?: string; id?: string; intent?: string | null; media_id?: string | null; phase?: Database["public"]["Enums"]["tour_phase"] | null; role: Database["public"]["Enums"]["message_role"]; session_id: string; step_position?: number | null; text: string }
        Update: { created_at?: string; id?: string; intent?: string | null; media_id?: string | null; phase?: Database["public"]["Enums"]["tour_phase"] | null; role?: Database["public"]["Enums"]["message_role"]; session_id?: string; step_position?: number | null; text?: string }
        Relationships: []
      }
      session_step_states: {
      ...
      steps: {
        ...
        Update: { address?: string | null; arrive_script?: string | null; body?: string | null; created_at?: string; experience_id?: string; id?: string; is_paywall?: boolean; knowledge_scope?: Json; lat?: number | null; lng?: number | null; meta?: Json; meta_verified?: boolean; orientation_hint?: string | null; payoff?: string | null; paywall_message?: string | null; place_query?: string | null; position?: number; proposal?: string | null; title?: string | null; type?: Database["public"]["Enums"]["step_type"]; updated_at?: string; walk_to_next?: string | null }
        Relationships: []
      }
      stripe_events: {
    ...
    Views: {
      experiences_public: {
        Row: { city: string | null; cover_path: string | null; currency: string | null; expected_minutes: number | null; id: string | null; language: string | null; paywall_position: number | null; pitch: string | null; price_cents: number | null; published_at: string | null; slug: string | null; title: string | null }
        Relationships: []
      }
    }
    Functions: {
