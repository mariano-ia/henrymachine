...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      purchases: {
        Row: { marketing_consent: boolean | null; amount_cents: number; anon_id: string | null; created_at: string; currency: string; experience_id: string; id: string; paid_at: string | null; purchaser_email: string | null; refunded_at: string | null; status: Database["public"]["Enums"]["purchase_status"]; stripe_checkout_session_id: string | null; stripe_event_id: string | null; stripe_payment_intent_id: string | null; user_id: string | null }
        Insert: { marketing_consent?: boolean | null; amount_cents?: number; anon_id?: string | null; created_at?: string; currency?: string; experience_id: string; id?: string; paid_at?: string | null; purchaser_email?: string | null; refunded_at?: string | null; status?: Database["public"]["Enums"]["purchase_status"]; stripe_checkout_session_id?: string | null; stripe_event_id?: string | null; stripe_payment_intent_id?: string | null; user_id?: string | null }
        Update: { marketing_consent?: boolean | null; amount_cents?: number; anon_id?: string | null; created_at?: string; currency?: string; experience_id?: string; id?: string; paid_at?: string | null; purchaser_email?: string | null; refunded_at?: string | null; status?: Database["public"]["Enums"]["purchase_status"]; stripe_checkout_session_id?: string | null; stripe_event_id?: string | null; stripe_payment_intent_id?: string | null; user_id?: string | null }
        Relationships: []
      }
      sales: {
